...
public class AssociatedApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public AssociatedApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public AssociatedApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call getUserAccountsCall(Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getUserAccountsValidateBeforeCall(Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback _callback) throws ApiException {
        return getUserAccountsCall(pagesize, page, filter, paramCallback, _callback);

    }


    private ApiResponse<List<NetworkUsersInner>> getUserAccountsWithHttpInfo(Integer pagesize, Integer page, String filter, String paramCallback) throws ApiException {
        okhttp3.Call localVarCall = getUserAccountsValidateBeforeCall(pagesize, page, filter, paramCallback, null);
        Type localVarReturnType = new TypeToken<List<NetworkUsersInner>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getUserAccountsAsync(Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback<List<NetworkUsersInner>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUserAccountsValidateBeforeCall(pagesize, page, filter, paramCallback, _callback);
        Type localVarReturnType = new TypeToken<List<NetworkUsersInner>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetUserAccountsRequestBuilder {
        private Integer pagesize;
        private Integer page;
        private String filter;
        private String paramCallback;

        private GetUserAccountsRequestBuilder() {
        }

        /**
         * Set pagesize
         * @param pagesize  (optional)
         * @return GetUserAccountsRequestBuilder
         */
        public GetUserAccountsRequestBuilder pagesize(Integer pagesize) {
         ...
         * @return GetUserAccountsRequestBuilder
         */
        public GetUserAccountsRequestBuilder page(Integer page) {
            this.page = page;
            return this;
        }
         ...
         * @return GetUserAccountsRequestBuilder
         */
        public GetUserAccountsRequestBuilder filter(String filter) {
            this.filter = filter;
            return this;
        }
         ...
         * @return GetUserAccountsRequestBuilder
         */
        public GetUserAccountsRequestBuilder paramCallback(String paramCallback) {
        ...
        /**
         * Execute getUserAccounts request
        ...
        public List<NetworkUsersInner> execute() throws ApiException {
            ApiResponse<List<NetworkUsersInner>> localVarResp = getUserAccountsWithHttpInfo(pagesize, page, filter, paramCallback);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getUserAccounts request with HTTP info returned
        ...
        public ApiResponse<List<NetworkUsersInner>> executeWithHttpInfo() throws ApiException {
            return getUserAccountsWithHttpInfo(pagesize, page, filter, paramCallback);
        }

        /**
         * Execute getUserAccounts request (asynchronously)
        ...
        public okhttp3.Call executeAsync(final ApiCallback<List<NetworkUsersInner>> _callback) throws ApiException {
            return getUserAccountsAsync(pagesize, page, filter, paramCallback, _callback);
        }
    }
     ...
     */
    public GetUserAccountsRequestBuilder getUserAccounts() throws IllegalArgumentException {
        return new GetUserAccountsRequestBuilder();
    }
}
