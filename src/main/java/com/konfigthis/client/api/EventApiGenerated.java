...
public class EventApiGenerated {
    ...
    private okhttp3.Call listEventsCall(String site, Integer pagesize, Integer page, String filter, String paramCallback, Integer since, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call listEventsValidateBeforeCall(String site, Integer pagesize, Integer page, String filter, String paramCallback, Integer since, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'site' is set
        if (site == null) {
            throw new ApiException("Missing the required parameter 'site' when calling listEvents(Async)");
        }

        return listEventsCall(site, pagesize, page, filter, paramCallback, since, _callback);

    }


    private ApiResponse<List<EventsInner>> listEventsWithHttpInfo(String site, Integer pagesize, Integer page, String filter, String paramCallback, Integer since) throws ApiException {
        okhttp3.Call localVarCall = listEventsValidateBeforeCall(site, pagesize, page, filter, paramCallback, since, null);
        Type localVarReturnType = new TypeToken<List<EventsInner>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listEventsAsync(String site, Integer pagesize, Integer page, String filter, String paramCallback, Integer since, final ApiCallback<List<EventsInner>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listEventsValidateBeforeCall(site, pagesize, page, filter, paramCallback, since, _callback);
        Type localVarReturnType = new TypeToken<List<EventsInner>>(){}.getType();
    ...
    public class ListEventsRequestBuilder {
        ...
        private ListEventsRequestBuilder(String site) {
            this.site = site;
        }
         ...
         */
        public ListEventsRequestBuilder pagesize(Integer pagesize) {
         ...
         * @return ListEventsRequestBuilder
         */
        public ListEventsRequestBuilder filter(String filter) {
            this.filter = filter;
            return this;
        }
         ...
         * @return ListEventsRequestBuilder
         */
        public ListEventsRequestBuilder paramCallback(String paramCallback) {
         ...
         * @return ListEventsRequestBuilder
         */
        public ListEventsRequestBuilder since(Integer since) {
            this.since = since;
            return this;
        }
         ...
         */
        public List<EventsInner> execute() throws ApiException {
            ApiResponse<List<EventsInner>> localVarResp = listEventsWithHttpInfo(site, pagesize, page, filter, paramCallback, since);
         ...
         */
        public ApiResponse<List<EventsInner>> executeWithHttpInfo() throws ApiException {
            return listEventsWithHttpInfo(site, pagesize, page, filter, paramCallback, since);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<EventsInner>> _callback) throws ApiException {
            return listEventsAsync(site, pagesize, page, filter, paramCallback, since, _callback);
        }
    }
     ...
     */
    public ListEventsRequestBuilder listEvents(String site) throws IllegalArgumentException {
        if (site == null) throw new IllegalArgumentException("\"site\" is required but got null");
            

        return new ListEventsRequestBuilder(site);
    }
}
