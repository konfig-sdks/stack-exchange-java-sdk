...
public class MessageApiGenerated {
    ...
    private okhttp3.Call getInboxItemsCall(String site, Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getInboxItemsValidateBeforeCall(String site, Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback _callback) throws ApiException {
        ...
        return getInboxItemsCall(site, pagesize, page, filter, paramCallback, _callback);

    }


    private ApiResponse<List<InboxItemsInner>> getInboxItemsWithHttpInfo(String site, Integer pagesize, Integer page, String filter, String paramCallback) throws ApiException {
        okhttp3.Call localVarCall = getInboxItemsValidateBeforeCall(site, pagesize, page, filter, paramCallback, null);
        Type localVarReturnType = new TypeToken<List<InboxItemsInner>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getInboxItemsAsync(String site, Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback<List<InboxItemsInner>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getInboxItemsValidateBeforeCall(site, pagesize, page, filter, paramCallback, _callback);
        Type localVarReturnType = new TypeToken<List<InboxItemsInner>>(){}.getType();
    ...
    public class GetInboxItemsRequestBuilder {
        ...
        private GetInboxItemsRequestBuilder(String site) {
            this.site = site;
        }
        ...
        public List<InboxItemsInner> execute() throws ApiException {
            ApiResponse<List<InboxItemsInner>> localVarResp = getInboxItemsWithHttpInfo(site, pagesize, page, filter, paramCallback);
        ...
        public ApiResponse<List<InboxItemsInner>> executeWithHttpInfo() throws ApiException {
            return getInboxItemsWithHttpInfo(site, pagesize, page, filter, paramCallback);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<List<InboxItemsInner>> _callback) throws ApiException {
            return getInboxItemsAsync(site, pagesize, page, filter, paramCallback, _callback);
        }
    }
     ...
     */
    public GetInboxItemsRequestBuilder getInboxItems(String site) throws IllegalArgumentException {
        if (site == null) throw new IllegalArgumentException("\"site\" is required but got null");
            

        return new GetInboxItemsRequestBuilder(site);
    }
    private okhttp3.Call getUnreadItemsCall(Integer pagesize, Integer page, String filter, String paramCallback, Integer since, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUnreadItemsValidateBeforeCall(Integer pagesize, Integer page, String filter, String paramCallback, Integer since, final ApiCallback _callback) throws ApiException {
        return getUnreadItemsCall(pagesize, page, filter, paramCallback, since, _callback);

    }


    private ApiResponse<List<InboxItemsInner>> getUnreadItemsWithHttpInfo(Integer pagesize, Integer page, String filter, String paramCallback, Integer since) throws ApiException {
        okhttp3.Call localVarCall = getUnreadItemsValidateBeforeCall(pagesize, page, filter, paramCallback, since, null);
        Type localVarReturnType = new TypeToken<List<InboxItemsInner>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getUnreadItemsAsync(Integer pagesize, Integer page, String filter, String paramCallback, Integer since, final ApiCallback<List<InboxItemsInner>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUnreadItemsValidateBeforeCall(pagesize, page, filter, paramCallback, since, _callback);
        Type localVarReturnType = new TypeToken<List<InboxItemsInner>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetUnreadItemsRequestBuilder {
        private Integer pagesize;
        private Integer page;
        private String filter;
        private String paramCallback;
        ...
        private GetUnreadItemsRequestBuilder() {
        }

        /**
         * Set pagesize
         * @param pagesize  (optional)
         * @return GetUnreadItemsRequestBuilder
         */
        public GetUnreadItemsRequestBuilder pagesize(Integer pagesize) {
            this.pagesize = pagesize;
            return this;
        }
         ...
         * @return GetUnreadItemsRequestBuilder
         */
        public GetUnreadItemsRequestBuilder page(Integer page) {
            this.page = page;
            return this;
        }
         ...
         * @return GetUnreadItemsRequestBuilder
         */
        public GetUnreadItemsRequestBuilder filter(String filter) {
            this.filter = filter;
            return this;
        }
         ...
         * @return GetUnreadItemsRequestBuilder
         */
        public GetUnreadItemsRequestBuilder paramCallback(String paramCallback) {
            this.paramCallback = paramCallback;
            return this;
        }
         ...
         * @return GetUnreadItemsRequestBuilder
         */
        public GetUnreadItemsRequestBuilder since(Integer since) {
            this.since = since;
            return this;
        }
        
        /**
         * Build call for getUnreadItems
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute getUnreadItems request
         * @return List&lt;InboxItemsInner&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public List<InboxItemsInner> execute() throws ApiException {
            ApiResponse<List<InboxItemsInner>> localVarResp = getUnreadItemsWithHttpInfo(pagesize, page, filter, paramCallback, since);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getUnreadItems request with HTTP info returned
         * @return ApiResponse&lt;List&lt;InboxItemsInner&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<List<InboxItemsInner>> executeWithHttpInfo() throws ApiException {
            return getUnreadItemsWithHttpInfo(pagesize, page, filter, paramCallback, since);
        }

        /**
         * Execute getUnreadItems request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<InboxItemsInner>> _callback) throws ApiException {
            return getUnreadItemsAsync(pagesize, page, filter, paramCallback, since, _callback);
        }
    }
     ...
     */
    public GetUnreadItemsRequestBuilder getUnreadItems() throws IllegalArgumentException {
        return new GetUnreadItemsRequestBuilder();
    }
    private okhttp3.Call listInboxItemsCall(Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listInboxItemsValidateBeforeCall(Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback _callback) throws ApiException {
        return listInboxItemsCall(pagesize, page, filter, paramCallback, _callback);

    }


    private ApiResponse<List<InboxItemsInner>> listInboxItemsWithHttpInfo(Integer pagesize, Integer page, String filter, String paramCallback) throws ApiException {
        okhttp3.Call localVarCall = listInboxItemsValidateBeforeCall(pagesize, page, filter, paramCallback, null);
        Type localVarReturnType = new TypeToken<List<InboxItemsInner>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listInboxItemsAsync(Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback<List<InboxItemsInner>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listInboxItemsValidateBeforeCall(pagesize, page, filter, paramCallback, _callback);
        Type localVarReturnType = new TypeToken<List<InboxItemsInner>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class ListInboxItemsRequestBuilder {
        private Integer pagesize;
        private Integer page;
        private String filter;
        private String paramCallback;

        private ListInboxItemsRequestBuilder() {
        }

        /**
         * Set pagesize
         * @param pagesize  (optional)
         * @return ListInboxItemsRequestBuilder
         */
        public ListInboxItemsRequestBuilder pagesize(Integer pagesize) {
            this.pagesize = pagesize;
            return this;
        }
         ...
         * @return ListInboxItemsRequestBuilder
         */
        public ListInboxItemsRequestBuilder page(Integer page) {
            this.page = page;
            return this;
        }
         ...
         * @return ListInboxItemsRequestBuilder
         */
        public ListInboxItemsRequestBuilder filter(String filter) {
            this.filter = filter;
            return this;
        }
         ...
         * @return ListInboxItemsRequestBuilder
         */
        public ListInboxItemsRequestBuilder paramCallback(String paramCallback) {
            this.paramCallback = paramCallback;
            return this;
        }
        
        /**
         * Build call for listInboxItems
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute listInboxItems request
         * @return List&lt;InboxItemsInner&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public List<InboxItemsInner> execute() throws ApiException {
            ApiResponse<List<InboxItemsInner>> localVarResp = listInboxItemsWithHttpInfo(pagesize, page, filter, paramCallback);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listInboxItems request with HTTP info returned
         * @return ApiResponse&lt;List&lt;InboxItemsInner&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<List<InboxItemsInner>> executeWithHttpInfo() throws ApiException {
            return listInboxItemsWithHttpInfo(pagesize, page, filter, paramCallback);
        }

        /**
         * Execute listInboxItems request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<InboxItemsInner>> _callback) throws ApiException {
            return listInboxItemsAsync(pagesize, page, filter, paramCallback, _callback);
        }
    }
     ...
     */
    public ListInboxItemsRequestBuilder listInboxItems() throws IllegalArgumentException {
        return new ListInboxItemsRequestBuilder();
    }
}
