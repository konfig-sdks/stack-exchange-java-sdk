...
public class FavoriteApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public FavoriteApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public FavoriteApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call getUserFavoritesCall(String site, String order, String max, String min, String sort, Integer fromdate, Integer todate, Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getUserFavoritesValidateBeforeCall(String site, String order, String max, String min, String sort, Integer fromdate, Integer todate, Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'site' is set
        if (site == null) {
            throw new ApiException("Missing the required parameter 'site' when calling getUserFavorites(Async)");
        }

        return getUserFavoritesCall(site, order, max, min, sort, fromdate, todate, pagesize, page, filter, paramCallback, _callback);

    }


    private ApiResponse<List<QuestionsInner>> getUserFavoritesWithHttpInfo(String site, String order, String max, String min, String sort, Integer fromdate, Integer todate, Integer pagesize, Integer page, String filter, String paramCallback) throws ApiException {
        okhttp3.Call localVarCall = getUserFavoritesValidateBeforeCall(site, order, max, min, sort, fromdate, todate, pagesize, page, filter, paramCallback, null);
        Type localVarReturnType = new TypeToken<List<QuestionsInner>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getUserFavoritesAsync(String site, String order, String max, String min, String sort, Integer fromdate, Integer todate, Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback<List<QuestionsInner>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUserFavoritesValidateBeforeCall(site, order, max, min, sort, fromdate, todate, pagesize, page, filter, paramCallback, _callback);
        Type localVarReturnType = new TypeToken<List<QuestionsInner>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetUserFavoritesRequestBuilder {
        ...
        private GetUserFavoritesRequestBuilder(String site) {
            this.site = site;
        }
         ...
         * @return GetUserFavoritesRequestBuilder
         */
        public GetUserFavoritesRequestBuilder order(String order) {
            this.order = order;
            return this;
        }
         ...
         * @return GetUserFavoritesRequestBuilder
         */
        public GetUserFavoritesRequestBuilder max(String max) {
            this.max = max;
            return this;
        }
         ...
         * @return GetUserFavoritesRequestBuilder
         */
        public GetUserFavoritesRequestBuilder min(String min) {
            this.min = min;
            return this;
        }
         ...
         * @return GetUserFavoritesRequestBuilder
         */
        public GetUserFavoritesRequestBuilder sort(String sort) {
            this.sort = sort;
            return this;
        }
         ...
         * @return GetUserFavoritesRequestBuilder
         */
        public GetUserFavoritesRequestBuilder fromdate(Integer fromdate) {
         ...
         * @return GetUserFavoritesRequestBuilder
         */
        public GetUserFavoritesRequestBuilder todate(Integer todate) {
            this.todate = todate;
            return this;
        }
         ...
         * @return GetUserFavoritesRequestBuilder
         */
        public GetUserFavoritesRequestBuilder pagesize(Integer pagesize) {
         ...
         * @return GetUserFavoritesRequestBuilder
         */
        public GetUserFavoritesRequestBuilder page(Integer page) {
            this.page = page;
            return this;
        }
         ...
         * @return GetUserFavoritesRequestBuilder
         */
        public GetUserFavoritesRequestBuilder filter(String filter) {
            this.filter = filter;
            return this;
        }
         ...
         * @return GetUserFavoritesRequestBuilder
         */
        public GetUserFavoritesRequestBuilder paramCallback(String paramCallback) {
        ...
        /**
         * Execute getUserFavorites request
        ...
        public List<QuestionsInner> execute() throws ApiException {
            ApiResponse<List<QuestionsInner>> localVarResp = getUserFavoritesWithHttpInfo(site, order, max, min, sort, fromdate, todate, pagesize, page, filter, paramCallback);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getUserFavorites request with HTTP info returned
        ...
        public ApiResponse<List<QuestionsInner>> executeWithHttpInfo() throws ApiException {
            return getUserFavoritesWithHttpInfo(site, order, max, min, sort, fromdate, todate, pagesize, page, filter, paramCallback);
        }

        /**
         * Execute getUserFavorites request (asynchronously)
        ...
        public okhttp3.Call executeAsync(final ApiCallback<List<QuestionsInner>> _callback) throws ApiException {
            return getUserFavoritesAsync(site, order, max, min, sort, fromdate, todate, pagesize, page, filter, paramCallback, _callback);
        }
    }
     ...
     */
    public GetUserFavoritesRequestBuilder getUserFavorites(String site) throws IllegalArgumentException {
        if (site == null) throw new IllegalArgumentException("\"site\" is required but got null");
            

        return new GetUserFavoritesRequestBuilder(site);
    }
}
