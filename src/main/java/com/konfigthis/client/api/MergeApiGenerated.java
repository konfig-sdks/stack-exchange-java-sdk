...
public class MergeApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public MergeApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public MergeApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call getAccountMergeListCall(Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAccountMergeListValidateBeforeCall(Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback _callback) throws ApiException {
        return getAccountMergeListCall(pagesize, page, filter, paramCallback, _callback);

    }


    private ApiResponse<List<AccountMergeInner>> getAccountMergeListWithHttpInfo(Integer pagesize, Integer page, String filter, String paramCallback) throws ApiException {
        okhttp3.Call localVarCall = getAccountMergeListValidateBeforeCall(pagesize, page, filter, paramCallback, null);
        Type localVarReturnType = new TypeToken<List<AccountMergeInner>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getAccountMergeListAsync(Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback<List<AccountMergeInner>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAccountMergeListValidateBeforeCall(pagesize, page, filter, paramCallback, _callback);
        Type localVarReturnType = new TypeToken<List<AccountMergeInner>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetAccountMergeListRequestBuilder {
        private Integer pagesize;
        private Integer page;
        private String filter;
        private String paramCallback;

        private GetAccountMergeListRequestBuilder() {
        }

        /**
         * Set pagesize
         * @param pagesize  (optional)
         * @return GetAccountMergeListRequestBuilder
         */
        public GetAccountMergeListRequestBuilder pagesize(Integer pagesize) {
         ...
         * @return GetAccountMergeListRequestBuilder
         */
        public GetAccountMergeListRequestBuilder page(Integer page) {
            this.page = page;
            return this;
        }
         ...
         * @return GetAccountMergeListRequestBuilder
         */
        public GetAccountMergeListRequestBuilder filter(String filter) {
            this.filter = filter;
            return this;
        }
         ...
         * @return GetAccountMergeListRequestBuilder
         */
        public GetAccountMergeListRequestBuilder paramCallback(String paramCallback) {
            this.paramCallback = paramCallback;
            return this;
        }
        
        /**
         * Build call for getAccountMergeList
        ...
        /**
         * Execute getAccountMergeList request
        ...
        public List<AccountMergeInner> execute() throws ApiException {
            ApiResponse<List<AccountMergeInner>> localVarResp = getAccountMergeListWithHttpInfo(pagesize, page, filter, paramCallback);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getAccountMergeList request with HTTP info returned
        ...
        public ApiResponse<List<AccountMergeInner>> executeWithHttpInfo() throws ApiException {
            return getAccountMergeListWithHttpInfo(pagesize, page, filter, paramCallback);
        }

        /**
         * Execute getAccountMergeList request (asynchronously)
        ...
        public okhttp3.Call executeAsync(final ApiCallback<List<AccountMergeInner>> _callback) throws ApiException {
            return getAccountMergeListAsync(pagesize, page, filter, paramCallback, _callback);
        }
    }
     ...
     */
    public GetAccountMergeListRequestBuilder getAccountMergeList() throws IllegalArgumentException {
        return new GetAccountMergeListRequestBuilder();
    }
}
