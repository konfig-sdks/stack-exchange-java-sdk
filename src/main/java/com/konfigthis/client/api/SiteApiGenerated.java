...
public class SiteApiGenerated {
    ...
    private okhttp3.Call listSitesCall(Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call listSitesValidateBeforeCall(Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback _callback) throws ApiException {
        return listSitesCall(pagesize, page, filter, paramCallback, _callback);

    }


    private ApiResponse<List<InboxItemsInnerSite>> listSitesWithHttpInfo(Integer pagesize, Integer page, String filter, String paramCallback) throws ApiException {
        okhttp3.Call localVarCall = listSitesValidateBeforeCall(pagesize, page, filter, paramCallback, null);
        Type localVarReturnType = new TypeToken<List<InboxItemsInnerSite>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listSitesAsync(Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback<List<InboxItemsInnerSite>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listSitesValidateBeforeCall(pagesize, page, filter, paramCallback, _callback);
        Type localVarReturnType = new TypeToken<List<InboxItemsInnerSite>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class ListSitesRequestBuilder {
        private Integer pagesize;
        private Integer page;
        private String filter;
        private String paramCallback;

        private ListSitesRequestBuilder() {
        }

        /**
         * Set pagesize
         * @param pagesize  (optional)
         * @return ListSitesRequestBuilder
         */
        public ListSitesRequestBuilder pagesize(Integer pagesize) {
         ...
         * @return ListSitesRequestBuilder
         */
        public ListSitesRequestBuilder page(Integer page) {
            this.page = page;
            return this;
        }
         ...
         * @return ListSitesRequestBuilder
         */
        public ListSitesRequestBuilder filter(String filter) {
            this.filter = filter;
            return this;
        }
         ...
         * @return ListSitesRequestBuilder
         */
        public ListSitesRequestBuilder paramCallback(String paramCallback) {
         ...
         */
        public List<InboxItemsInnerSite> execute() throws ApiException {
            ApiResponse<List<InboxItemsInnerSite>> localVarResp = listSitesWithHttpInfo(pagesize, page, filter, paramCallback);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listSites request with HTTP info returned
         ...
         */
        public ApiResponse<List<InboxItemsInnerSite>> executeWithHttpInfo() throws ApiException {
            return listSitesWithHttpInfo(pagesize, page, filter, paramCallback);
        }

        /**
         * Execute listSites request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<InboxItemsInnerSite>> _callback) throws ApiException {
            return listSitesAsync(pagesize, page, filter, paramCallback, _callback);
        }
    }
     ...
     */
    public ListSitesRequestBuilder listSites() throws IllegalArgumentException {
        return new ListSitesRequestBuilder();
    }
}
