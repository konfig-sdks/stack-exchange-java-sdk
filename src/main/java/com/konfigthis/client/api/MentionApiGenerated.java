...
public class MentionApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public MentionApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public MentionApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call userCommentsListCall(String site, String order, String max, String min, String sort, Integer fromdate, Integer todate, Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call userCommentsListValidateBeforeCall(String site, String order, String max, String min, String sort, Integer fromdate, Integer todate, Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'site' is set
        if (site == null) {
            throw new ApiException("Missing the required parameter 'site' when calling userCommentsList(Async)");
        }

        return userCommentsListCall(site, order, max, min, sort, fromdate, todate, pagesize, page, filter, paramCallback, _callback);

    }


    private ApiResponse<List<CommentsInner>> userCommentsListWithHttpInfo(String site, String order, String max, String min, String sort, Integer fromdate, Integer todate, Integer pagesize, Integer page, String filter, String paramCallback) throws ApiException {
        okhttp3.Call localVarCall = userCommentsListValidateBeforeCall(site, order, max, min, sort, fromdate, todate, pagesize, page, filter, paramCallback, null);
        Type localVarReturnType = new TypeToken<List<CommentsInner>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call userCommentsListAsync(String site, String order, String max, String min, String sort, Integer fromdate, Integer todate, Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback<List<CommentsInner>> _callback) throws ApiException {

        okhttp3.Call localVarCall = userCommentsListValidateBeforeCall(site, order, max, min, sort, fromdate, todate, pagesize, page, filter, paramCallback, _callback);
        Type localVarReturnType = new TypeToken<List<CommentsInner>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class UserCommentsListRequestBuilder {
        ...
        private UserCommentsListRequestBuilder(String site) {
            this.site = site;
        }
         ...
         * @return UserCommentsListRequestBuilder
         */
        public UserCommentsListRequestBuilder order(String order) {
            this.order = order;
            return this;
        }
         ...
         * @return UserCommentsListRequestBuilder
         */
        public UserCommentsListRequestBuilder max(String max) {
            this.max = max;
            return this;
        }
         ...
         * @return UserCommentsListRequestBuilder
         */
        public UserCommentsListRequestBuilder min(String min) {
            this.min = min;
            return this;
        }
         ...
         * @return UserCommentsListRequestBuilder
         */
        public UserCommentsListRequestBuilder sort(String sort) {
            this.sort = sort;
            return this;
        }
         ...
         * @return UserCommentsListRequestBuilder
         */
        public UserCommentsListRequestBuilder fromdate(Integer fromdate) {
         ...
         * @return UserCommentsListRequestBuilder
         */
        public UserCommentsListRequestBuilder todate(Integer todate) {
            this.todate = todate;
            return this;
        }
         ...
         * @return UserCommentsListRequestBuilder
         */
        public UserCommentsListRequestBuilder pagesize(Integer pagesize) {
         ...
         * @return UserCommentsListRequestBuilder
         */
        public UserCommentsListRequestBuilder page(Integer page) {
            this.page = page;
            return this;
        }
         ...
         * @return UserCommentsListRequestBuilder
         */
        public UserCommentsListRequestBuilder filter(String filter) {
            this.filter = filter;
            return this;
        }
         ...
         * @return UserCommentsListRequestBuilder
         */
        public UserCommentsListRequestBuilder paramCallback(String paramCallback) {
            this.paramCallback = paramCallback;
            return this;
        }
        
        /**
         * Build call for userCommentsList
        ...
        /**
         * Execute userCommentsList request
        ...
        public List<CommentsInner> execute() throws ApiException {
            ApiResponse<List<CommentsInner>> localVarResp = userCommentsListWithHttpInfo(site, order, max, min, sort, fromdate, todate, pagesize, page, filter, paramCallback);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute userCommentsList request with HTTP info returned
        ...
        public ApiResponse<List<CommentsInner>> executeWithHttpInfo() throws ApiException {
            return userCommentsListWithHttpInfo(site, order, max, min, sort, fromdate, todate, pagesize, page, filter, paramCallback);
        }

        /**
         * Execute userCommentsList request (asynchronously)
        ...
        public okhttp3.Call executeAsync(final ApiCallback<List<CommentsInner>> _callback) throws ApiException {
            return userCommentsListAsync(site, order, max, min, sort, fromdate, todate, pagesize, page, filter, paramCallback, _callback);
        }
    }
     ...
     */
    public UserCommentsListRequestBuilder userCommentsList(String site) throws IllegalArgumentException {
        if (site == null) throw new IllegalArgumentException("\"site\" is required but got null");
            

        return new UserCommentsListRequestBuilder(site);
    }
}
