...
public class RevisionApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public RevisionApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public RevisionApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call listRevisionsByIdsCall(String ids, String site, Integer fromdate, Integer todate, Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call listRevisionsByIdsValidateBeforeCall(String ids, String site, Integer fromdate, Integer todate, Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'ids' is set
        if (ids == null) {
            throw new ApiException("Missing the required parameter 'ids' when calling listRevisionsByIds(Async)");
        }

        // verify the required parameter 'site' is set
        if (site == null) {
            throw new ApiException("Missing the required parameter 'site' when calling listRevisionsByIds(Async)");
        }

        return listRevisionsByIdsCall(ids, site, fromdate, todate, pagesize, page, filter, paramCallback, _callback);

    }


    private ApiResponse<List<RevisionsInner>> listRevisionsByIdsWithHttpInfo(String ids, String site, Integer fromdate, Integer todate, Integer pagesize, Integer page, String filter, String paramCallback) throws ApiException {
        okhttp3.Call localVarCall = listRevisionsByIdsValidateBeforeCall(ids, site, fromdate, todate, pagesize, page, filter, paramCallback, null);
        Type localVarReturnType = new TypeToken<List<RevisionsInner>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listRevisionsByIdsAsync(String ids, String site, Integer fromdate, Integer todate, Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback<List<RevisionsInner>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listRevisionsByIdsValidateBeforeCall(ids, site, fromdate, todate, pagesize, page, filter, paramCallback, _callback);
        Type localVarReturnType = new TypeToken<List<RevisionsInner>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class ListRevisionsByIdsRequestBuilder {
        ...
        private ListRevisionsByIdsRequestBuilder(String ids, String site) {
            this.ids = ids;
            this.site = site;
        }
         ...
         * @return ListRevisionsByIdsRequestBuilder
         */
        public ListRevisionsByIdsRequestBuilder fromdate(Integer fromdate) {
         ...
         * @return ListRevisionsByIdsRequestBuilder
         */
        public ListRevisionsByIdsRequestBuilder todate(Integer todate) {
            this.todate = todate;
            return this;
        }
         ...
         * @return ListRevisionsByIdsRequestBuilder
         */
        public ListRevisionsByIdsRequestBuilder pagesize(Integer pagesize) {
         ...
         * @return ListRevisionsByIdsRequestBuilder
         */
        public ListRevisionsByIdsRequestBuilder page(Integer page) {
            this.page = page;
            return this;
        }
         ...
         * @return ListRevisionsByIdsRequestBuilder
         */
        public ListRevisionsByIdsRequestBuilder filter(String filter) {
            this.filter = filter;
            return this;
        }
         ...
         * @return ListRevisionsByIdsRequestBuilder
         */
        public ListRevisionsByIdsRequestBuilder paramCallback(String paramCallback) {
            this.paramCallback = paramCallback;
            return this;
        }
        
        /**
         * Build call for listRevisionsByIds
        ...
        /**
         * Execute listRevisionsByIds request
        ...
        public List<RevisionsInner> execute() throws ApiException {
            ApiResponse<List<RevisionsInner>> localVarResp = listRevisionsByIdsWithHttpInfo(ids, site, fromdate, todate, pagesize, page, filter, paramCallback);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listRevisionsByIds request with HTTP info returned
        ...
        public ApiResponse<List<RevisionsInner>> executeWithHttpInfo() throws ApiException {
            return listRevisionsByIdsWithHttpInfo(ids, site, fromdate, todate, pagesize, page, filter, paramCallback);
        }

        /**
         * Execute listRevisionsByIds request (asynchronously)
        ...
        public okhttp3.Call executeAsync(final ApiCallback<List<RevisionsInner>> _callback) throws ApiException {
            return listRevisionsByIdsAsync(ids, site, fromdate, todate, pagesize, page, filter, paramCallback, _callback);
        }
    }
     ...
     */
    public ListRevisionsByIdsRequestBuilder listRevisionsByIds(String ids, String site) throws IllegalArgumentException {
        ...
        return new ListRevisionsByIdsRequestBuilder(ids, site);
    }
}
