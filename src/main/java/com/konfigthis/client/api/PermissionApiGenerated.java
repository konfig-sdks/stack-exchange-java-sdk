...
public class PermissionApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public PermissionApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public PermissionApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call getUserWritePermissionsCall(String site, Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getUserWritePermissionsValidateBeforeCall(String site, Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'site' is set
        if (site == null) {
            throw new ApiException("Missing the required parameter 'site' when calling getUserWritePermissions(Async)");
        }

        return getUserWritePermissionsCall(site, pagesize, page, filter, paramCallback, _callback);

    }


    private ApiResponse<List<WritePermissionsInner>> getUserWritePermissionsWithHttpInfo(String site, Integer pagesize, Integer page, String filter, String paramCallback) throws ApiException {
        okhttp3.Call localVarCall = getUserWritePermissionsValidateBeforeCall(site, pagesize, page, filter, paramCallback, null);
        Type localVarReturnType = new TypeToken<List<WritePermissionsInner>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getUserWritePermissionsAsync(String site, Integer pagesize, Integer page, String filter, String paramCallback, final ApiCallback<List<WritePermissionsInner>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUserWritePermissionsValidateBeforeCall(site, pagesize, page, filter, paramCallback, _callback);
        Type localVarReturnType = new TypeToken<List<WritePermissionsInner>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetUserWritePermissionsRequestBuilder {
        ...
        private GetUserWritePermissionsRequestBuilder(String site) {
            this.site = site;
        }
         ...
         * @return GetUserWritePermissionsRequestBuilder
         */
        public GetUserWritePermissionsRequestBuilder pagesize(Integer pagesize) {
         ...
         * @return GetUserWritePermissionsRequestBuilder
         */
        public GetUserWritePermissionsRequestBuilder page(Integer page) {
            this.page = page;
            return this;
        }
         ...
         * @return GetUserWritePermissionsRequestBuilder
         */
        public GetUserWritePermissionsRequestBuilder filter(String filter) {
            this.filter = filter;
            return this;
        }
         ...
         * @return GetUserWritePermissionsRequestBuilder
         */
        public GetUserWritePermissionsRequestBuilder paramCallback(String paramCallback) {
            this.paramCallback = paramCallback;
            return this;
        }
        
        /**
         * Build call for getUserWritePermissions
        ...
        /**
         * Execute getUserWritePermissions request
        ...
        public List<WritePermissionsInner> execute() throws ApiException {
            ApiResponse<List<WritePermissionsInner>> localVarResp = getUserWritePermissionsWithHttpInfo(site, pagesize, page, filter, paramCallback);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getUserWritePermissions request with HTTP info returned
        ...
        public ApiResponse<List<WritePermissionsInner>> executeWithHttpInfo() throws ApiException {
            return getUserWritePermissionsWithHttpInfo(site, pagesize, page, filter, paramCallback);
        }

        /**
         * Execute getUserWritePermissions request (asynchronously)
        ...
        public okhttp3.Call executeAsync(final ApiCallback<List<WritePermissionsInner>> _callback) throws ApiException {
            return getUserWritePermissionsAsync(site, pagesize, page, filter, paramCallback, _callback);
        }
    }
     ...
     */
    public GetUserWritePermissionsRequestBuilder getUserWritePermissions(String site) throws IllegalArgumentException {
        if (site == null) throw new IllegalArgumentException("\"site\" is required but got null");
            

        return new GetUserWritePermissionsRequestBuilder(site);
    }
}
