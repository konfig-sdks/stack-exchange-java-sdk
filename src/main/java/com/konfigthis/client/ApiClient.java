...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api.stackexchange.com/2.0";
    ...
    private RetryingOAuth setupOauth(String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        authentications.put("oauth_2_0", oauth);
        return oauth;
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.stackexchange.com/2.0)
