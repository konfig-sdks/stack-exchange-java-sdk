...
import com.konfigthis.client.model.QuestionsInnerClosedDetails;
import com.konfigthis.client.model.QuestionsInnerMigratedFrom;
import com.konfigthis.client.model.QuestionsInnerNotice;
...
public class QuestionsInner {
  ...
  **/
   ...
   * @return the QuestionsInner instance itself
   */
  public QuestionsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, questionsInner.tags) &&
        Objects.equals(this.title, questionsInner.title) &&
        Objects.equals(this.acceptedAnswerId, questionsInner.acceptedAnswerId) &&
        ...
        Objects.equals(this.additionalProperties, questionsInner.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tags, title, acceptedAnswerId, answerCount, answers, body, bodyMarkdown, bountyAmount, bountyClosesDate, bountyUser, canClose, canFlag, closeVoteCount, closedDate, closedDetails, closedReason, commentCount, comments, communityOwnedDate, creationDate, deleteVoteCount, downVoteCount, downvoted, favoriteCount, favorited, isAnswered, lastActivityDate, lastEditDate, lastEditor, link, lockedDate, migratedFrom, migratedTo, notice, owner, protectedDate, questionId, reopenVoteCount, score, shareLink, upVoteCount, upvoted, viewCount, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to QuestionsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!QuestionsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("bounty_user") != null && !jsonObj.get("bounty_user").isJsonNull()) {
        AnswersInnerLastEditor.validateJsonObject(jsonObj.getAsJsonObject("bounty_user"));
      }
      // validate the optional field `closed_details`
      if (jsonObj.get("closed_details") != null && !jsonObj.get("closed_details").isJsonNull()) {
        QuestionsInnerClosedDetails.validateJsonObject(jsonObj.getAsJsonObject("closed_details"));
      }
      ...
      if (jsonObj.get("migrated_from") != null && !jsonObj.get("migrated_from").isJsonNull()) {
        QuestionsInnerMigratedFrom.validateJsonObject(jsonObj.getAsJsonObject("migrated_from"));
      }
      // validate the optional field `migrated_to`
      if (jsonObj.get("migrated_to") != null && !jsonObj.get("migrated_to").isJsonNull()) {
        QuestionsInnerMigratedFrom.validateJsonObject(jsonObj.getAsJsonObject("migrated_to"));
      }
      // validate the optional field `notice`
      if (jsonObj.get("notice") != null && !jsonObj.get("notice").isJsonNull()) {
        QuestionsInnerNotice.validateJsonObject(jsonObj.getAsJsonObject("notice"));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<QuestionsInner>() {
           ...
           public QuestionsInner read(JsonReader in) throws IOException {
             ...
             QuestionsInner instance = thisAdapter.fromJsonTree(jsonObj);
