...
public class CommentsInner {
  ...
  public CommentsInner() {
  }

  public CommentsInner body(String body) {
  ...
  **/
  ...
  public CommentsInner bodyMarkdown(String bodyMarkdown) {
  ...
  **/
  ...
  public CommentsInner canFlag(Boolean canFlag) {
  ...
  **/
  ...
  public CommentsInner commentId(Integer commentId) {
  ...
  **/
  ...
  public CommentsInner creationDate(Integer creationDate) {
  ...
  **/
  ...
  public CommentsInner edited(Boolean edited) {
  ...
  **/
  ...
  public CommentsInner link(String link) {
  ...
  **/
  ...
  public CommentsInner owner(AnswersInnerLastEditor owner) {
  ...
  **/
  ...
  public CommentsInner postId(Integer postId) {
  ...
  **/
  ...
  public CommentsInner postType(String postType) {
  ...
  **/
  ...
  public CommentsInner replyToUser(AnswersInnerLastEditor replyToUser) {
  ...
  **/
  ...
  public CommentsInner score(Integer score) {
  ...
  **/
  ...
  public CommentsInner upvoted(Boolean upvoted) {
  ...
  **/
   ...
   * @return the CommentsInner instance itself
   */
  public CommentsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CommentsInner commentsInner = (CommentsInner) o;
    return Objects.equals(this.body, commentsInner.body) &&
        Objects.equals(this.bodyMarkdown, commentsInner.bodyMarkdown) &&
        Objects.equals(this.canFlag, commentsInner.canFlag) &&
        Objects.equals(this.commentId, commentsInner.commentId) &&
        Objects.equals(this.creationDate, commentsInner.creationDate) &&
        Objects.equals(this.edited, commentsInner.edited) &&
        Objects.equals(this.link, commentsInner.link) &&
        Objects.equals(this.owner, commentsInner.owner) &&
        Objects.equals(this.postId, commentsInner.postId) &&
        Objects.equals(this.postType, commentsInner.postType) &&
        Objects.equals(this.replyToUser, commentsInner.replyToUser) &&
        Objects.equals(this.score, commentsInner.score) &&
        Objects.equals(this.upvoted, commentsInner.upvoted)&&
        Objects.equals(this.additionalProperties, commentsInner.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CommentsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CommentsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CommentsInner is not found in the empty JSON string", CommentsInner.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CommentsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CommentsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CommentsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CommentsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<CommentsInner>() {
           @Override
           public void write(JsonWriter out, CommentsInner value) throws IOException {
           ...
           @Override
           public CommentsInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CommentsInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CommentsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CommentsInner
  * @throws IOException if the JSON string is invalid with respect to CommentsInner
  */
  public static CommentsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CommentsInner.class);
  }

 /**
  * Convert an instance of CommentsInner to an JSON string
  *
  * @return JSON string
  */
