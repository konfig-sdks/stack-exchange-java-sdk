...
public class UsersInner {
  ...
  public UsersInner aboutMe(String aboutMe) {
  ...
  **/
  ...
  public UsersInner acceptRate(Integer acceptRate) {
  ...
  **/
  ...
  public UsersInner accountId(Integer accountId) {
  ...
  **/
  ...
  public UsersInner age(Integer age) {
  ...
  **/
  ...
  public UsersInner answerCount(Integer answerCount) {
  ...
  **/
  ...
  public UsersInner badgeCounts(AnswersInnerLastEditorBadgeCounts badgeCounts) {
  ...
  **/
  ...
  public UsersInner creationDate(Integer creationDate) {
  ...
  **/
  ...
  public UsersInner displayName(String displayName) {
  ...
  **/
  ...
  public UsersInner downVoteCount(Integer downVoteCount) {
  ...
  **/
  ...
  public UsersInner isEmployee(Boolean isEmployee) {
  ...
  **/
  ...
  public UsersInner lastAccessDate(Integer lastAccessDate) {
  ...
  **/
  ...
  public UsersInner lastModifiedDate(Integer lastModifiedDate) {
  ...
  **/
  ...
  public UsersInner link(String link) {
  ...
  **/
  ...
  public UsersInner location(String location) {
  ...
  **/
  ...
  public UsersInner profileImage(String profileImage) {
  ...
  **/
  ...
  public UsersInner questionCount(Integer questionCount) {
  ...
  **/
  ...
  public UsersInner reputation(Integer reputation) {
  ...
  **/
  ...
  public UsersInner reputationChangeDay(Integer reputationChangeDay) {
  ...
  **/
  ...
  public UsersInner reputationChangeMonth(Integer reputationChangeMonth) {
  ...
  **/
  ...
  public UsersInner reputationChangeQuarter(Integer reputationChangeQuarter) {
  ...
  **/
  ...
  public UsersInner reputationChangeWeek(Integer reputationChangeWeek) {
  ...
  **/
  ...
  public UsersInner reputationChangeYear(Integer reputationChangeYear) {
  ...
  **/
  ...
  public UsersInner timedPenaltyDate(Integer timedPenaltyDate) {
  ...
  **/
  ...
  public UsersInner upVoteCount(Integer upVoteCount) {
  ...
  **/
  ...
  public UsersInner userId(Integer userId) {
  ...
  **/
  ...
  public UsersInner userType(String userType) {
  ...
  **/
  ...
  public UsersInner viewCount(Integer viewCount) {
  ...
  **/
  ...
  public UsersInner websiteUrl(String websiteUrl) {
  ...
  **/
   ...
   * @return the UsersInner instance itself
   */
  public UsersInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.aboutMe, usersInner.aboutMe) &&
        Objects.equals(this.acceptRate, usersInner.acceptRate) &&
        Objects.equals(this.accountId, usersInner.accountId) &&
        Objects.equals(this.age, usersInner.age) &&
        Objects.equals(this.answerCount, usersInner.answerCount) &&
        Objects.equals(this.badgeCounts, usersInner.badgeCounts) &&
        Objects.equals(this.creationDate, usersInner.creationDate) &&
        Objects.equals(this.displayName, usersInner.displayName) &&
        Objects.equals(this.downVoteCount, usersInner.downVoteCount) &&
        Objects.equals(this.isEmployee, usersInner.isEmployee) &&
        Objects.equals(this.lastAccessDate, usersInner.lastAccessDate) &&
        Objects.equals(this.lastModifiedDate, usersInner.lastModifiedDate) &&
        Objects.equals(this.link, usersInner.link) &&
        Objects.equals(this.location, usersInner.location) &&
        Objects.equals(this.profileImage, usersInner.profileImage) &&
        Objects.equals(this.questionCount, usersInner.questionCount) &&
        Objects.equals(this.reputation, usersInner.reputation) &&
        Objects.equals(this.reputationChangeDay, usersInner.reputationChangeDay) &&
        Objects.equals(this.reputationChangeMonth, usersInner.reputationChangeMonth) &&
        Objects.equals(this.reputationChangeQuarter, usersInner.reputationChangeQuarter) &&
        Objects.equals(this.reputationChangeWeek, usersInner.reputationChangeWeek) &&
        Objects.equals(this.reputationChangeYear, usersInner.reputationChangeYear) &&
        Objects.equals(this.timedPenaltyDate, usersInner.timedPenaltyDate) &&
        Objects.equals(this.upVoteCount, usersInner.upVoteCount) &&
        Objects.equals(this.userId, usersInner.userId) &&
        Objects.equals(this.userType, usersInner.userType) &&
        Objects.equals(this.viewCount, usersInner.viewCount) &&
        Objects.equals(this.websiteUrl, usersInner.websiteUrl)&&
        Objects.equals(this.additionalProperties, usersInner.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aboutMe, acceptRate, accountId, age, answerCount, badgeCounts, creationDate, displayName, downVoteCount, isEmployee, lastAccessDate, lastModifiedDate, link, location, profileImage, questionCount, reputation, reputationChangeDay, reputationChangeMonth, reputationChangeQuarter, reputationChangeWeek, reputationChangeYear, timedPenaltyDate, upVoteCount, userId, userType, viewCount, websiteUrl, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UsersInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UsersInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UsersInner is not found in the empty JSON string", UsersInner.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UsersInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UsersInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UsersInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UsersInner.class));

       return (TypeAdapter<T>) new TypeAdapter<UsersInner>() {
           @Override
           public void write(JsonWriter out, UsersInner value) throws IOException {
           ...
           @Override
           public UsersInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UsersInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UsersInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UsersInner
  * @throws IOException if the JSON string is invalid with respect to UsersInner
  */
  public static UsersInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UsersInner.class);
  }

 /**
  * Convert an instance of UsersInner to an JSON string
  *
  * @return JSON string
  */
