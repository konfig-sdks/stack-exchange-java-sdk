...
|------------- | ------------- | -------------|
| [**getUnreadItemsInInbox**](NotificationApi.md#getUnreadItemsInInbox) | **GET** /me/inbox/unread |  |
| [**getUnreadItemsInInbox_0**](NotificationApi.md#getUnreadItemsInInbox_0) | **GET** /me/notifications/unread |  |
| [**getUserNotifications**](NotificationApi.md#getUserNotifications) | **GET** /notifications |  |
| [**getUserNotificationsList**](NotificationApi.md#getUserNotificationsList) | **GET** /me/notifications |  |
| [**getUserUnreadNotifications**](NotificationApi.md#getUserUnreadNotifications) | **GET** /notifications/unread |  |


<a name="getUnreadItemsInInbox"></a>
# **getUnreadItemsInInbox**
> List&lt;InboxItemsInner&gt; getUnreadItemsInInbox(site).pagesize(pagesize).page(page).filter(filter).paramCallback(paramCallback).since(since).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling NotificationApi#getUnreadItemsInInbox");
...
<a name="getUnreadItemsInInbox_0"></a>
# **getUnreadItemsInInbox_0**
> List&lt;NotificationsInner&gt; getUnreadItemsInInbox_0(site).pagesize(pagesize).page(page).filter(filter).paramCallback(paramCallback).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling NotificationApi#getUnreadItemsInInbox_0");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
> List&lt;NotificationsInner&gt; getUserNotifications().pagesize(pagesize).page(page).filter(filter).paramCallback(paramCallback).execute();
...
<a name="getUserNotificationsList"></a>
# **getUserNotificationsList**
> List&lt;NotificationsInner&gt; getUserNotificationsList(site).pagesize(pagesize).page(page).filter(filter).paramCallback(paramCallback).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling NotificationApi#getUserNotificationsList");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="getUserUnreadNotifications"></a>
# **getUserUnreadNotifications**
> List&lt;NotificationsInner&gt; getUserUnreadNotifications().pagesize(pagesize).page(page).filter(filter).paramCallback(paramCallback).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling NotificationApi#getUserUnreadNotifications");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
