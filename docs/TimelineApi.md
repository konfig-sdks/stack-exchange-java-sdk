...
|------------- | ------------- | -------------|
| [**getUserTimeline**](TimelineApi.md#getUserTimeline) | **GET** /me/timeline |  |


<a name="getUserTimeline"></a>
# **getUserTimeline**
> List&lt;UserTimelineObjectsInner&gt; getUserTimeline(site).fromdate(fromdate).todate(todate).pagesize(pagesize).page(page).filter(filter).paramCallback(paramCallback).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling TimelineApi#getUserTimeline");
