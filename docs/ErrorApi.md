...
|------------- | ------------- | -------------|
| [**generateError**](ErrorApi.md#generateError) | **GET** /errors/{id} |  |
| [**listErrors**](ErrorApi.md#listErrors) | **GET** /errors |  |


<a name="generateError"></a>
# **generateError**
> Error generateError(id).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.out.println(result.getErrorId());
      System.out.println(result.getErrorMessage());
      System.out.println(result.getErrorName());
    } catch (ApiException e) {
      System.err.println("Exception when calling ErrorApi#generateError");
    ...
    try {
      ApiResponse<Error> response = client
              .error
              .generateError(id)
              .executeWithHttpInfo();
...
<a name="listErrors"></a>
# **listErrors**
> List&lt;ErrorsInner&gt; listErrors().pagesize(pagesize).page(page).filter(filter).paramCallback(paramCallback).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<ErrorsInner> result = client
              .error
              .listErrors()
              .pagesize(pagesize)
              .page(page)
      ...
      System.err.println("Exception when calling ErrorApi#listErrors");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
    ...
    // Use .executeWithHttpInfo() to retrieve HTTP Status Code, Headers and Request
    try {
      ApiResponse<List<ErrorsInner>> response = client
              .error
              .listErrors()
              .pagesize(pagesize)
              .page(page)
...
[**List&lt;ErrorsInner&gt;**](ErrorsInner.md)
