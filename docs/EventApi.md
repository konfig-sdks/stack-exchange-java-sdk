...
|------------- | ------------- | -------------|
| [**listEvents**](EventApi.md#listEvents) | **GET** /events |  |


<a name="listEvents"></a>
# **listEvents**
> List&lt;EventsInner&gt; listEvents(site).pagesize(pagesize).page(page).filter(filter).paramCallback(paramCallback).since(since).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<EventsInner> result = client
              .event
              .listEvents(site)
              .pagesize(pagesize)
              .page(page)
    ...
    try {
      ApiResponse<List<EventsInner>> response = client
              .event
              .listEvents(site)
              .pagesize(pagesize)
              .page(page)
...
[**List&lt;EventsInner&gt;**](EventsInner.md)
