...
|------------- | ------------- | -------------|
| [**getAccountMergeList**](MergeApi.md#getAccountMergeList) | **GET** /me/merges |  |


<a name="getAccountMergeList"></a>
# **getAccountMergeList**
> List&lt;AccountMergeInner&gt; getAccountMergeList().pagesize(pagesize).page(page).filter(filter).paramCallback(paramCallback).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling MergeApi#getAccountMergeList");
