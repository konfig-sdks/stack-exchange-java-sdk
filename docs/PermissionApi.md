...
|------------- | ------------- | -------------|
| [**getUserWritePermissions**](PermissionApi.md#getUserWritePermissions) | **GET** /me/write-permissions |  |


<a name="getUserWritePermissions"></a>
# **getUserWritePermissions**
> List&lt;WritePermissionsInner&gt; getUserWritePermissions(site).pagesize(pagesize).page(page).filter(filter).paramCallback(paramCallback).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling PermissionApi#getUserWritePermissions");
