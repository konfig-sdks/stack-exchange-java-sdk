...
|------------- | ------------- | -------------|
| [**getInboxItems**](MessageApi.md#getInboxItems) | **GET** /me/inbox |  |
| [**getUnreadItems**](MessageApi.md#getUnreadItems) | **GET** /inbox/unread |  |
| [**listInboxItems**](MessageApi.md#listInboxItems) | **GET** /inbox |  |


<a name="getInboxItems"></a>
# **getInboxItems**
> List&lt;InboxItemsInner&gt; getInboxItems(site).pagesize(pagesize).page(page).filter(filter).paramCallback(paramCallback).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling MessageApi#getInboxItems");
...
<a name="getUnreadItems"></a>
# **getUnreadItems**
> List&lt;InboxItemsInner&gt; getUnreadItems().pagesize(pagesize).page(page).filter(filter).paramCallback(paramCallback).since(since).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling MessageApi#getUnreadItems");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="listInboxItems"></a>
# **listInboxItems**
> List&lt;InboxItemsInner&gt; listInboxItems().pagesize(pagesize).page(page).filter(filter).paramCallback(paramCallback).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling MessageApi#listInboxItems");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
